...
To build the final jar and optimize the moneyMarketBi application for production, run:
...
Then navigate to [http://localhost:8575](http://localhost:8575) in your browser.
