...
import { sampleWithRequiredData } from '../money-market-list.test-samples';
import { MoneyMarketListService } from '../service/money-market-list.service';

import { MoneyMarketListComponent } from './money-market-list.component';
import SpyInstance = jest.SpyInstance;

describe('MoneyMarketList Management Component', () => {
  let comp: MoneyMarketListComponent;
  let fixture: ComponentFixture<MoneyMarketListComponent>;
  let service: MoneyMarketListService;
  let routerNavigateSpy: SpyInstance<Promise<boolean>>;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [MoneyMarketListComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(MoneyMarketListComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(MoneyMarketListComponent);
