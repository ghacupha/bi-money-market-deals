...
const securityClearanceResolve = (route: ActivatedRouteSnapshot): Observable<null | ISecurityClearance> => {
  const id = route.params.id;
  if (id) {
    return inject(SecurityClearanceService)
      .find(id)
      .pipe(
...
export default securityClearanceResolve;
