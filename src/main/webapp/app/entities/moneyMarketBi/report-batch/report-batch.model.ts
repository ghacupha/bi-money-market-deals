...
export interface IReportBatch {
  ...
  processFlag?: keyof typeof FileProcessFlag | null;
  csvFileAttachment?: string | null;
  csvFileAttachmentContentType?: string | null;
  uploadedBy?: Pick<IApplicationUser, 'id' | 'applicationIdentity'> | null;
  placeholders?: Pick<IPlaceholder, 'id' | 'token'>[] | null;
}

export type NewReportBatch = Omit<IReportBatch, 'id'> & { id: null };
