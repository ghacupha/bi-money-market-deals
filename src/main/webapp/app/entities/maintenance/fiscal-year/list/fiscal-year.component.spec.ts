...
import { sampleWithRequiredData } from '../fiscal-year.test-samples';
...
describe('FiscalYear Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.fiscalYears()[0]).toEqual(expect.objectContaining({ id: 1297 }));
  });

  describe('trackId', () => {
    it('should forward to fiscalYearService', () => {
      const entity = { id: 1297 };
      jest.spyOn(service, 'getFiscalYearIdentifier');
      const id = comp.trackId(entity);
      expect(service.getFiscalYearIdentifier).toHaveBeenCalledWith(entity);
