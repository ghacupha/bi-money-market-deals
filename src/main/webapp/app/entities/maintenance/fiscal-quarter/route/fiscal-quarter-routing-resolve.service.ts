...
const fiscalQuarterResolve = (route: ActivatedRouteSnapshot): Observable<null | IFiscalQuarter> => {
  const id = route.params.id;
  if (id) {
    return inject(FiscalQuarterService)
      .find(id)
      .pipe(
...
export default fiscalQuarterResolve;
