...
import { FiscalQuarterFormGroup, FiscalQuarterFormService } from './fiscal-quarter-form.service';
...
export class FiscalQuarterUpdateComponent implements OnInit {
  ...
  protected fiscalQuarterFormService = inject(FiscalQuarterFormService);
