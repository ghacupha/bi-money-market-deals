...
/**
 * Service Interface for managing {@link io.github.bi.domain.FiscalQuarter}.
 */
public interface FiscalQuarterService {
    ...
    /**
     * Updates a fiscalQuarter.
     *
     * @param fiscalQuarterDTO the entity to update.
     * @return the persisted entity.
     */
    FiscalQuarterDTO update(FiscalQuarterDTO fiscalQuarterDTO);
