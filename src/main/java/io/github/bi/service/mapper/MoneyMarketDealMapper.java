...
/**
 * Mapper for the entity {@link MoneyMarketDeal} and its DTO {@link MoneyMarketDealDTO}.
 */
@Mapper(componentModel = "spring")
public interface MoneyMarketDealMapper extends EntityMapper<MoneyMarketDealDTO, MoneyMarketDeal> {
    @Mapping(target = "moneyMarketList", source = "moneyMarketList", qualifiedByName = "moneyMarketListDescription")
    MoneyMarketDealDTO toDto(MoneyMarketDeal s);
