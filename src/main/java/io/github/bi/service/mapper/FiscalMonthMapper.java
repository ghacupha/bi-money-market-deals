...
public interface FiscalMonthMapper extends EntityMapper<FiscalMonthDTO, FiscalMonth> {
    ...
    @Mapping(target = "fiscalQuarter", source = "fiscalQuarter", qualifiedByName = "fiscalQuarterFiscalQuarterCode")
    ...
    @Named("fiscalQuarterFiscalQuarterCode")
    @BeanMapping(ignoreByDefault = true)
    @Mapping(target = "id", source = "id")
    @Mapping(target = "fiscalQuarterCode", source = "fiscalQuarterCode")
    FiscalQuarterDTO toDtoFiscalQuarterFiscalQuarterCode(FiscalQuarter fiscalQuarter);
}
