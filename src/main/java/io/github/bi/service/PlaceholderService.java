...
/**
 * Service Interface for managing {@link io.github.bi.domain.Placeholder}.
 */
public interface PlaceholderService {
     ...
     * @return the persisted entity.
     */
    PlaceholderDTO update(PlaceholderDTO placeholderDTO);
     ...
     */
    Page<PlaceholderDTO> findAllWithEagerRelationships(Pageable pageable);
