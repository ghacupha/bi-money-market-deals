...
/**
 * Service Interface for managing {@link io.github.bi.domain.FiscalMonth}.
 */
public interface FiscalMonthService {
    ...
    /**
     * Updates a fiscalMonth.
     *
     * @param fiscalMonthDTO the entity to update.
     * @return the persisted entity.
     */
    FiscalMonthDTO update(FiscalMonthDTO fiscalMonthDTO);
