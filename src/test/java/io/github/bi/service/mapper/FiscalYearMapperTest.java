...
class FiscalYearMapperTest {
    ...
    @BeforeEach
    void setUp() {
        fiscalYearMapper = new FiscalYearMapperImpl();
    }

    @Test
    void shouldConvertToDtoAndBack() {
        var expected = getFiscalYearSample1();
        var actual = fiscalYearMapper.toEntity(fiscalYearMapper.toDto(expected));
        assertFiscalYearAllPropertiesEquals(expected, actual);
    }
}
