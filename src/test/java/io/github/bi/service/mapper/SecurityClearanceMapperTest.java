...
class SecurityClearanceMapperTest {
    ...
    void shouldConvertToDtoAndBack() {
        var expected = getSecurityClearanceSample1();
        var actual = securityClearanceMapper.toEntity(securityClearanceMapper.toDto(expected));
        assertSecurityClearanceAllPropertiesEquals(expected, actual);
    }
}
