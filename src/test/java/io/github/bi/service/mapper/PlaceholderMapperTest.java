...
class PlaceholderMapperTest {
    ...
    void shouldConvertToDtoAndBack() {
        var expected = getPlaceholderSample1();
        var actual = placeholderMapper.toEntity(placeholderMapper.toDto(expected));
        assertPlaceholderAllPropertiesEquals(expected, actual);
    }
}
